...
internals.String.prototype.creditCard = function () {
    ...
    return this._test('creditCard', undefined, function (value, state, options) {
        ...
        if (/^(62|88)/.test(value) && (value.length >= 16 && value.length <= 19)) {
            return null;
        }
...
internals.String.prototype.cvc = function () {
    ...
    return this._test('cvc', undefined, function (value, state, options) {
        ...
        return value.length >= 3 && value.length <= 4 && isnum ? null : Errors.create('string.cvc', { value: value }, state, options);
    });
};

internals.String.prototype.phoneNumber = function () {

    return this._test('phoneNumber', undefined, function (value, state, options) {

        var isPhoneNumber = /^([+]?[0-9- ]+)$/.test(value.trim());
        return value.trim().length >= 5 && isPhoneNumber ? null : Errors.create('string.phoneNumber', { value: value.trim() }, state, options);
    });
};
